...
function insertaUsuario($connexio){
   ...
   $sql2 = "INSERT INTO usuarios (email, nombre, apellido1, apellido2, contraseña, telefono) VALUES (:email, :nombre, :apellido1, :apellido2, :contrasena, :telefono)";
   ...
   $consulta2 = $connexio->prepare($sql2);
    ...
    $consulta2->bindParam( ':telefono', $telefono, PDO::PARAM_INT);
